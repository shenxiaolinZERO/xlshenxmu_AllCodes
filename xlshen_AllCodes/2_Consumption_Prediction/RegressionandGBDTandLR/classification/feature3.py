...
class Feature3:
    ...
    def go(dataset_dir, feature_dir, feature_para=(1, 2, 3, 4)):
        ...
        for i in range(len(data_para_list)):
            ...
            Feature3.print_feature(click_file_path, buy_file_path, data_para, write_file_path, print_para, item_list, feature_para)

    @staticmethod
    def print_feature(click_file_path, buy_file_path, data_para, write_file_path, print_para, item_list, feature_para):
