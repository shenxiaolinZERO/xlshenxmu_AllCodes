...
public class LibRec {
	...
	protected void preset(String configFile) throws Exception {
		...
		Recommender.cf = cf;
		Recommender.cf.setString("dataset.ratings.wins",BiasedMFRanking.trainFile==null?BPRRanking.trainFile:BiasedMFRanking.trainFile);
		Recommender.cf.setString("evaluation.setup","test-set -f "+(BiasedMFRanking.testFile==null?BPRRanking.testFile:BiasedMFRanking.testFile));
		
		//System.out.println(cf.getString("dataset.ratings.wins")+"(((((((((");
		//System.out.println(cf.getString("evaluation.setup")+"(((((((((");
