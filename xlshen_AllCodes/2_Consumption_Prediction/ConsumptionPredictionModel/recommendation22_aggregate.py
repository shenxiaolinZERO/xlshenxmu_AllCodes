...
class Recommendation22_aggregate:

    @staticmethod
    def generate(click_file_path, buy_file_path, test_file_path,
                 U, V, theta, aspects_num, session_item_data, dic, item_session_times_dic, session_click_stream,
...
def print_2_excel(res_dir, aggregate_method, data):
    res_file_path = res_dir + '\\' + 'Recommendation22_aggregate' + str(aggregate_method) + '.csv'
