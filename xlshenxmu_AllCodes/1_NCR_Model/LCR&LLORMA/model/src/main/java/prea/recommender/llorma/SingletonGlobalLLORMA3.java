...
/**
 * THIS IS PARALLEL IMPLEMENTATION OF SINGLETON LLORMA.
 * IF THIS WORKS CORRECTLY, WE WOULD REPLACE WITH THIS.
 * 
 ...
 * @version 1.2
 */
public class SingletonGlobalLLORMA3 implements Recommender {
	/*========================================
	 * Common Variables
	 *========================================*/
	 ...
	 */
	public SingletonGlobalLLORMA3(int uc, int ic, double max, double min, int fc,
